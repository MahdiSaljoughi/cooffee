  ...
  return (
    <>
      <div className="relative">
        <img
          src="/coffe/images/headerBgDesktop.webp"
          alt="home"
          className="hidden xs:block"
        />
        <img
          src="/coffe/images/headerBgMobile.webp"
          alt="home"
          className="block xs:hidden"
        />
        <div className="absolute -top-6 xs:-top-2 xs:left-4 -left-2 sm:top-1/4 md:top-0 lg:top-1/4 xl:top-1/3 sm:left-1/4 md:left-0 lg:left-10 xl:left-1/4 text-white rounded-3xl flex items-center justify-start contain">
          <div>
            <h2 className="text-xl md:text-6xl/[62px] mb-0.5 md:mb-6 font-[fontm1]">
              قهوه عربیکا تانزانیا
            </h2>
            <span className="text-lg md:text-5xl/[64px] block">
              یک فنجان بالانس
            </span>
            <span className="block w-[100px] h-px md:h-0.5 bg-orange-300 my-2 md:my-8"></span>
      ...
      <main className="contain flex flex-col gap-y-2">
        <section className="products md:pt-10 cursor-default">
          <div>
            <div className="flex justify-between items-end mb-5 md:mb-12">
              <div>
                <span className="section-title font-[fontm1] mb-4 md:mb-8 block">
                  جدیدترین محصولات
                </span>
        ...
        <section className="category-banner mt-8 mb-10 md:my-20">
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-white">
              <Link
                href="/"
                className="category-banner-bg1 flex flex-col justify-center pr-7 md:pr-12 rounded-2xl h-[100px] md:h-[130px] xl:h-[200px] shadow-sha-normal"
              >
                <span className="font-DanaDemiBold text-2xl/6 md:text-4xl/6text-2xl/6 mb-4 md:mb-7">
                  انواع قهوه
                </span>
                <span className="md:font-DanaMedium md:text-xl/6text-2xl/6">
                  ترکیبی و تک خاستگاه
                </span>
              </Link>
              <Link
                href="/"
                className="category-banner-bg2 flex flex-col justify-center pr-7 md:pr-12 rounded-2xl h-[100px] md:h-[130px] xl:h-[200px] shadow-sha-normal"
              >
                <span className="font-DanaDemiBold text-2xl/6 md:text-4xl/6text-2xl/6 mb-4 md:mb-7">
                  پودر های فوری
                </span>
        ...
        <section className="products-category mb-10 md:mb-20 cursor-default">
          <div>
            <div className="flex items-center justify-center gap-y-6 gap-[29px] md:gap-[65px] flex-wrap">
              <div className="w-25 md:w-50 text-center">
                <Link href="/">
                  <img
                    src="/coffe/images/categories/category1.png"
                    loading="lazy"
                    alt="p1"
                  />
                  <span
                    className="inline-block font-DanaDemiBold text-sm md:text-xl mt-1.5 md:mt-2.5
              ...
              <div className="w-25 md:w-50 text-center">
                <Link href="/">
                  <img
                    src="/coffe/images/categories/category2.png"
                    loading="lazy"
                    alt="p1"
                  />
                  <span
              ...
              <div className="w-25 md:w-50 text-center">
                <Link href="/">
                  <img
                    src="/coffe/images/categories/category3.png"
                    loading="lazy"
                    alt="p1"
                  />
                  <span
              ...
              <div className="w-25 md:w-50 text-center">
                <Link href="/">
                  <img
                    src="/coffe/images/categories/category4.png"
                    loading="lazy"
                    alt="p1"
                  />
                  <span
              ...
              <div className="w-25 md:w-50 text-center">
                <Link href="/">
                  <img
                    src="/coffe/images/categories/category5.png"
                    loading="lazy"
                    alt="p1"
                  />
                  <span
        ...
        <section className="coffee-club mb-8 md:mb-20 cursor-default">
          <div>
            <div
              className="flex items-center flex-wrap lg:flex-nowrap lg:gap-x-4 xl:gap-x-24 gap-y-9 bg-gradient-to-r 
          from-emerald-400 to-emerald-600 
          lg:h-36 px-3 py-8 lg:py-0 lg:px-5 xl:px-11 text-white rounded-2xl"
            >
              <div className="flex items-center md:shrink-0 gap-x-3 lg:gap-x-4 xl:gap-x-6">
                <img
                  src="/coffe/images/club/diamond.png"
        ...
        <section className="mb-8 md:mb-28">
          <div className="flex justify-between items-center mb-5 md:mb-12 cursor-default">
            <div>
              <h3 className="section-title">مطالب خواندنی</h3>
            </div>
            <Link href="/mag" className="section-link">
        ...
        <section className="contact-us mb-16 md:mb-28 cursor-default">
          <div>
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-y-8 lg:gap-x-5">
              <img
                src="/coffe/images/contact.png"
                alt="Contact"
                className="shrink-0 w-[296px]"
              />
              <div className="text-zinc-700 dark:text-white">
                <h3 className="md:text-5xl font-MorabbaMedium mb-0.5 md:mb-1.5">
                  یکی از بهترین قهوه ها !
                </h3>
                <span className="text-lg md:text-3xl/[48px] font-MorabbaLight">
                ...
                <Link
                  href="/"
                  className="h-[50px] md:h-[60px] px-5 mt-5 md:mt-6 text-base md:text-lg gap-x-2 tracking-tightest text-orange-300 inline-flex items-center justify-center border md:border-2 border-orange-300 rounded-full"
                >
                  <svg
        ...
        <section className="services mb-16 md:mb-36">
          <div className="flex items-center justify-between gap-y-11 flex-wrap text-zinc-700 dark:text-white">
            <div className="flex items-center flex-col sm:flex-row gap-x-4 gap-y-5 text-center lg:text-right w-1/2 lg:w-auto">
              <svg
